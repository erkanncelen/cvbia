...
## FIRST PAGE
    ...
    if cv_data['education']:
        ...
        for edu in cv_data['education']:
            ...
            if edu['degree']:
                y = write(c, x, y, text=edu['degree'], font='bold', punto=8, color='trans_white', spacing=12)
            if edu['institution']:    
...
## EXPERIENCE PAGES
    ...
    y -= 12
    if cv_data["email"]:
        y = write(c, x, y, text="Email:", font='bold', punto=8, color='light_grey', spacing=0)
        y = write(c, x+40, y, text=cv_data['email'], font='regular', punto=8, color='dark_grey', spacing=0)
        y -= 15
    if 'phone' in cv_data and cv_data['phone']:
        y = write(c, x, y, text="Phone:", font='bold', punto=8, color='light_grey', spacing=0)
        y = write(c, x+40, y, text=cv_data['phone'], font='regular', punto=8, color='dark_grey', spacing=0)
        y -= 15
